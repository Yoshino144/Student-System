...
<body>
    ...
    <div id="head">
        ...
        <div id="logo">
            <p id="logo-text" style="color: #5c954e" >学生管理系统</p>
        </div>
        <p id="user-text" style="color: #5c954e" ><?php echo "用户:" . $_SESSION['username']; ?> </p>
        <a id="exit-text" href="login.php" style="color: #5c954e" >退出</a>
    </div>
    <div id="nav">
        <p id="text_nav">导航</p>
        <div id="menu">
